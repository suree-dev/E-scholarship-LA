...
<head>
    ...
    <style>
        /* บังคับใช้ฟอนต์ Prompt กับ SweetAlert2 */
        div:where(.swal2-container) {
            font-family: 'Prompt', sans-serif !important;
        }

        div:where(.swal2-container) h2.swal2-title {
            font-family: 'Prompt', sans-serif !important;
            font-weight: 600;
        }
...
<body class="bg-light">
    ...
    <div class="container py-5">
        <div class="app-form-container mx-auto">
            ...
            <form action="../scores/save_score.php" method="POST" class="scoring-panel" id="scoringForm">
                        ...
                        <div class="d-flex flex-column align-items-end gap-2">
                            ...
                            <?php else: ?>
                                <div class="d-flex gap-2">
                                    <button type="reset" class="btn btn-warning rounded-pill px-4 text-white" onclick="clearDraft()">รีเซ็ต</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!hasScored) {
                ...
                if (commentInput) commentInput.addEventListener('input', saveToDraft);
                if (scoreSelect) scoreSelect.addEventListener('change', saveToDraft);
